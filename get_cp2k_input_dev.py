...
#    &END XC
        ...
        self.sections_dict={
              ...
              'PhononsWorkchain'     :{'run_type' : 'NORMAL_MODES', 'xc' : self.xc_default , 'qs' : self.qs_default , 'motion' : True}
    ...
    def force_eval_mixed(self):
        ...
        first_slab_atom = self.inp_dict['first_slab_atom']
        last_slab_atom = self.inp_dict['last_slab_atom']
        ...
        force_eval = {
            ...
            'MIXED': {
                ...
                'MAPPING': {
                    'FORCE_EVAL_MIXED': {
                        'FRAGMENT':
                            [{'_': '1', ' ': '%d  %d' % (int(first_mol_atom), int(last_mol_atom))},
                             {'_': '2', ' ': '%d  %d' % (int(first_slab_atom), int(last_slab_atom))}],
                    },
