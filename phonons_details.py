...
class PHNSDetails(ipw.VBox):
    def __init__(self,job_details={}, proc_rep=12, num_rep=1,  **kwargs):
        ...
        self.proc_rep = ipw.IntText(value=proc_rep,
                           description='# Processors per replica',
                           style=style, layout=layout)  
        
        self.num_rep = ipw.IntText(value=num_rep,
    ...
    def reset(self,proc_rep=12, num_rep=1):  
